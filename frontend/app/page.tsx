...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans relative overflow-x-hidden text-slate-900">
      ...
      {/* 3. Footer */}
      <footer className="bg-white/5 backdrop-blur-2xl border-t border-white/20 pt-16 pb-8 z-10 relative mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input type="email" placeholder="Email" className="w-full px-4 py-2 rounded-xl bg-white/10 border border-white/20 text-sm focus:outline-none" />
                <button className="bg-indigo-600 text-white p-2 rounded-xl"><ArrowRight size={18} /></button>
              </div>
            </div>
          </div>
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <Twitter size={18} className="text-slate-500 hover:text-indigo-600 cursor-pointer"/>
              <Instagram size={18} className="text-slate-500 hover:text-pink-600 cursor-pointer"/>
